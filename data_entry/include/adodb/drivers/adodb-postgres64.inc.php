...
select viewname,'V' from pg_views where viewname like $mask";
	...
	*/
    ...
    // @modified 23 jul 2012 by bear@deepshiftlabs.com - added additional '$table' parameter to sprintf processing metaColumnsSQL template.
    // it's needed as fo some reasons ADODB uses here NOT ADODB_postgres64::metaColumnsSQL (2 placeholders) but ADODB_postgres7::metaColumnsSQL (3 placeholders)
    // Even if it's system-related issue this fix should not brake anything as when using right template additional "$table" will be ignored.
