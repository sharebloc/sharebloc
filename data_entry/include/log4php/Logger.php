...
class Logger {
	...
	private static $initialized = false;
        ...
        private $pass_filter = false;
        private $pass_filter_string = "!! ";
        private $block_filter = false;
        private $block_filter_string = "?? ";

        public function passFilterOn() {
            $this->pass_filter = true;
	}

        public function passFilterOff() {
            $this->pass_filter = false;
	}

        public function blockFilterOn() {
            $this->block_filter = true;
	}

        public function blockFilterOff() {
	...
	public function forcedLog($fqcn, $caller, $level, $message) {
		...
		if ($caller !== null && $caller instanceof Exception) {
			$throwable = $caller;							 
                ...
                if ($this->pass_filter) {
                    $message = $this->pass_filter_string.$message;
                }
                if ($this->block_filter) {
                    $message = $this->block_filter_string.$message;
                }
